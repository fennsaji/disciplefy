...
export const metadata: Metadata = {
  ...
  description:
    "Have real voice conversations about Scripture with your Voice Discipler. Ask Bible questions in English, Hindi, or Malayalam.",
  ...
  return (
    <NextIntlClientProvider locale="en" messages={messages as unknown as import("next-intl").AbstractIntlMessages}>
      <FeaturePageContent
        ...
        description="Have real voice conversations about any Bible passage or spiritual question with your Voice Discipler. Speaks naturally in English, Hindi, and Malayalam."
        howItWorks={[
          "Tap the microphone and ask any Bible question or name a passage",
          "Your Voice Discipler listens and responds naturally in your language",
