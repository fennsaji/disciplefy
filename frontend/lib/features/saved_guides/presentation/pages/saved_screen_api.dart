...
import '../widgets/guide_list_item_api.dart';
import '../widgets/empty_state_widget.dart';

/// Enhanced Saved Guides Screen with API integration
class SavedScreenApi extends StatefulWidget {
  const SavedScreenApi({super.key});

  @override
  State<SavedScreenApi> createState() => _SavedScreenApiState();
}

class _SavedScreenApiState extends State<SavedScreenApi> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          // Tab Content
          Expanded(
            child: BlocConsumer<SavedGuidesApiBloc, SavedGuidesState>(
