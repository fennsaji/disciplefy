...
class UserProfileModel extends UserProfileEntity {
  const UserProfileModel({
    ...
    super.defaultStudyMode,
    super.learningPathStudyMode,
    super.firstName,
    super.lastName,
  ...
  factory UserProfileModel.fromJson(Map<String, dynamic> json) {
    return UserProfileModel(
      ...
      defaultStudyMode: json['default_study_mode'] as String?,
      learningPathStudyMode: json['learning_path_study_mode'] as String?,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'learning_path_study_mode': learningPathStudyMode,
  ...
  factory UserProfileModel.fromEntity(UserProfileEntity entity) {
    return UserProfileModel(
      ...
      defaultStudyMode: entity.defaultStudyMode,
      learningPathStudyMode: entity.learningPathStudyMode,
  ...
  UserProfileEntity toEntity() {
    return UserProfileEntity(
      ...
      learningPathStudyMode: learningPathStudyMode,
      firstName: firstName,
      lastName: lastName,
  ...
  factory UserProfileModel.fromMap(Map<String, dynamic> map) {
    return UserProfileModel(
      ...
      defaultStudyMode: map['default_study_mode'] as String?,
      learningPathStudyMode: map['learning_path_study_mode'] as String?,
