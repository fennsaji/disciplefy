...
class _StandardUpgradePageState extends State<StandardUpgradePage>
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                if (_standardPlan?.hasDiscount == true) ...[
                  Padding(
                    padding: const EdgeInsets.only(top: 12.0, right: 8),
                    child: Text(
                      '₹${_standardPlan!.pricing.basePriceFormatted.toStringAsFixed(0)}',
                      style: AppFonts.inter(
                        fontSize: 18,
  ...
  Widget _buildComparison() {
    final prevName = _freePlan?.planName ?? 'Free';
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              '$prevName vs ${_standardPlan?.planName ?? 'Standard'}',
              style: AppFonts.poppins(
                fontSize: 18,
                fontWeight: FontWeight.w600,
                color: _standardPurple,
