  ...
  static const Map<String, dynamic> _englishTranslations = {
    'study_guide': {
      ...
      'error': {
        ...
        'insufficient_tokens':
            'You have run out of study credits. Please purchase more credits or upgrade to premium.',
        'go_back': 'Go Back',
        'try_again': 'Try Again',
  ...
  static const Map<String, dynamic> _hindiTranslations = {
    'study_guide': {
      ...
      'error': {
        ...
        'insufficient_tokens':
            'आपके अध्ययन क्रेडिट खत्म हो गए हैं। कृपया और क्रेडिट खरीदें या प्रीमियम में अपग्रेड करें।',
        'go_back': 'वापस जाएं',
  ...
  static const Map<String, dynamic> _malayalamTranslations = {
    'study_guide': {
      ...
      'error': {
        ...
        'insufficient_tokens':
            'പഠന ക്രെഡിറ്റുകൾ തീർന്നു. കൂടുതൽ ക്രെഡിറ്റുകൾ വാങ്ങുക അല്ലെങ്കിൽ പ്രീമിയത്തിലേക്ക് അപ്‌ഗ്രേഡ് ചെയ്യുക.',
        'go_back': 'തിരികെ പോകൂ',
