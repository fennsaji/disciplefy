...
class AppTranslations {
  ...
  static const Map<String, dynamic> _englishTranslations = {
    ...
    'my_plan': {
      ...
      'get_tokens_daily':
          'Get 20 tokens daily, AI study guides & more for just ₹79/month',
      ...
      'upgrade_to_standard': 'Upgrade to Standard',
      'upgrade_to_premium': 'Upgrade to Premium',
      'keep_premium_access': 'Keep Premium access for ₹499/month',
      'subscribe_to_standard': 'Subscribe to Standard',
      'after_trial': '₹79/month after trial',
      'subscribe_now': 'Subscribe Now',
      'keep_standard_access': 'Keep Standard access for ₹79/month',
      'get_all_features': 'Get all features for ₹499/month',
      'regain_access': 'Regain access for ₹79/month',
      'get_tokens_daily_for': 'Get 20 tokens daily for ₹79/month',
      'unlimited_tokens_for': 'Unlimited tokens for ₹499/month',
      'continue_after_trial': 'Continue after trial for ₹79/month',
      'continue_subscription': 'Continue Subscription',
  ...
  static const Map<String, dynamic> _hindiTranslations = {
    ...
    'my_plan': {
      ...
      'get_tokens_daily':
          'सिर्फ ₹79/माह में 20 टोकन दैनिक, AI स्टडी गाइड और भी बहुत कुछ',
      ...
      'upgrade_to_standard': 'स्टैंडर्ड में अपग्रेड करें',
      'upgrade_to_premium': 'प्रीमियम में अपग्रेड करें',
      'keep_premium_access': '₹499/माह में प्रीमियम एक्सेस रखें',
      'subscribe_to_standard': 'स्टैंडर्ड की सदस्यता लें',
      'after_trial': 'ट्रायल के बाद ₹79/माह',
      'subscribe_now': 'अभी सदस्यता लें',
      'keep_standard_access': '₹79/माह में स्टैंडर्ड एक्सेस रखें',
      'get_all_features': '₹499/माह में सभी सुविधाएं पाएं',
      'regain_access': '₹79/माह में फिर से एक्सेस पाएं',
      'get_tokens_daily_for': '₹79/माह में 20 टोकन दैनिक पाएं',
      'unlimited_tokens_for': '₹499/माह में असीमित टोकन',
      'continue_after_trial': 'ट्रायल के बाद ₹79/माह में जारी रखें',
  ...
  static const Map<String, dynamic> _malayalamTranslations = {
    ...
    'my_plan': {
      ...
      'get_tokens_daily':
          'വെറും ₹79/മാസത്തിന് 20 ടോക്കണുകൾ ദിവസവും, AI സ്റ്റഡി ഗൈഡുകൾ എന്നിവയും അതിലേറെയും',
      ...
      'keep_premium_access': '₹499/മാസത്തിന് പ്രീമിയം ആക്‌സസ് നിലനിർത്തുക',
      'subscribe_to_standard': 'സ്റ്റാൻഡേർഡിലേക്ക് സബ്‌സ്‌ക്രൈബ് ചെയ്യുക',
      'after_trial': 'ട്രയലിന് ശേഷം ₹79/മാസം',
      'subscribe_now': 'ഇപ്പോൾ സബ്‌സ്‌ക്രൈബ് ചെയ്യുക',
      'keep_standard_access': '₹79/മാസത്തിന് സ്റ്റാൻഡേർഡ് ആക്‌സസ് നിലനിർത്തുക',
      'get_all_features': '₹499/മാസത്തിന് എല്ലാ സവിശേഷതകളും നേടുക',
      'regain_access': '₹79/മാസത്തിന് വീണ്ടും ആക്‌സസ് നേടുക',
      'get_tokens_daily_for': '₹79/മാസത്തിന് 20 ടോക്കണുകൾ ദിവസവും നേടുക',
      'unlimited_tokens_for': '₹499/മാസത്തിന് അൺലിമിറ്റഡ് ടോക്കണുകൾ',
      'continue_after_trial': 'ട്രയലിന് ശേഷം ₹79/മാസത്തിന് തുടരുക',
