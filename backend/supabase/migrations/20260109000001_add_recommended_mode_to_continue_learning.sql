...
-- =============================================================================
-- FUNCTION: get_in_progress_topics (UPDATED)
-- =============================================================================
-- Enhanced to include recommended_mode for learning paths
...
BEGIN
  ...
  next_in_path AS (
    ...
    SELECT DISTINCT ON (lp.id)
      ...
      lp.recommended_mode AS recommended_mode
  ...
  -- Final SELECT with distinct topics (de-duplicate by topic_id)
