...
INSERT INTO recommended_topics_translations (topic_id, language_code, title, description, category) VALUES
  ...
  ('c0100000-e29b-41d4-a716-446655440004', 'ml', 'എഫെസ്യർ 4: യോഗ്യമായി നടക്കൽ', 'എഫെസ്യർ 4 വായിക്കുക. പൗലോസ് ഉപദേശത്തിൽ നിന്ന് ജീവിതത്തിലേക്ക് മാറുന്നു: "നിങ്ങളുടെ വിളിക്ക് യോഗ്യമായി നടക്കുക." ഏഴ് കാര്യങ്ങളിൽ അടിസ്ഥാനമിട്ട ഐക്യം — ഒരു ശരീരം, ഒരു ആത്മാവ്, ഒരു കർത്താവ്, ഒരു വിശ്വാസം. പഴയ മനുഷ്യനെ ഉരിഞ്���് പുതിയതിനെ ധരിക്കുക.', 'വിശ്വാസത്ത���ന്റെ അടിത്തറകൾ'),
...
INSERT INTO recommended_topics_translations (topic_id, language_code, title, description, category) VALUES
  ...
  ('c0400000-e29b-41d4-a716-446655440003', 'hi', 'फिलिप्पियों 3: लक्ष्य की ओर दौड़ना', 'फिलिप्पियों 3 पढ़ें। पौलुस मसीह यीशु को जानने की श्रेष्ठता के कारण सब कुछ हानि समझता है। यहूदी धर्म में उसकी योग्यता निर्दोष थी — पर वह सब कूड़ा गिनता है ताकि मसीह को पा ले। वह अभी पूरा नहीं हुआ पर परमेश्वर की ऊपरी बुलाहट के पुरस्कार के लिए आगे बढ़ता है।', '���िश्वास की नींव'),
...
INSERT INTO recommended_topics_translations (topic_id, language_code, title, description, category) VALUES
  ...
  ('c0600000-e29b-41d4-a716-446655440006', 'hi', '2 पतरस 1: भक्ति में बढ़ना', '2 पतरस 1 पढ़ें। परमेश्वर की ईश्वरीय सामर्थ्य ने हमें जीवन और भक्ति की सब वस्तुएँ दी हैं। बहुमूल्य और महान प्रतिज्ञाओं के द्वारा ईश्वरीय स्वभाव के भागी बनो। अपने विश्वास में सद्गुण, ज्ञान, संयम, धीरज, भक्ति, भाईचारे का प्रेम और प्रेम जोड़ते जाओ।', 'विश्व���स की नींव'),
  ('c0600000-e29b-41d4-a716-446655440006', 'ml', '2 പത്രോസ് 1: ഭക്തിയിൽ വളരൽ', '2 പത്രോസ് 1 വായിക്കുക. ദൈവത്തിന്റെ ദിവ്യശക്തി ജീവനും ഭക്തിക്കും വേണ്ടതെല്ലാം നൽകിയിരിക്കുന്നു. വിലയേറിയ മഹത്തായ വാഗ��ദത്തങ്ങളിലൂടെ ദൈവിക സ്വഭാവത്��ിൽ പങ്കാളികളാകുക. വിശ്വാസത്തിൽ സദ്ഗുണം, ജ്ഞാനം, ആത്മസംയമനം, സഹനം, ഭക്തി, സഹോദര സ്നേഹം, സ്നേഹം എന്നിവ ചേർത്തുകൊണ്ടിരിക്കുക.', 'വിശ്വാസത്തിന്റെ അടിത്തറകൾ'),
  ...
  ('c0600000-e29b-41d4-a716-446655440007', 'ml', '2 പത��രോസ് 2: വ്യാജ ഉപദേഷ്ട��ക്കൾ തുറന്നുകാട്ടപ്പെടുന്നു', '2 പത്രോസ് 2 വായിക്കുക. വ്യാജ ഉപദേഷ്ടാക്കൾ വിനാശകരമായ വ്യാജ ഉപദേശങ്ങൾ കൊണ്ടുവരും, തങ്ങളെ വിലയ്ക്ക് വാങ്ങിയ യജമാനനെ പോലും നിഷേധിക്കും. പാപം ചെയ്ത ദൂതന്മാരെയോ പഴയ ലോകത്തെയോ സൊദോം-ഗൊമോറയെയോ ദൈവം വെറുതെ വിട്ടില്ല — നീതിമാനായ ലോത്തിനെ രക്ഷിച്ചു. ഭക്തന്മാരെ പരീക്ഷയിൽ നിന്ന് വിടുവിക്കാൻ കർത്താവിന് അറിയാം.', 'വിശ്വാസത��തിന്റെ അടിത്തറകൾ'),
