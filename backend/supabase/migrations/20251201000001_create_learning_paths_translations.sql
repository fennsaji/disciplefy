-- Migration: Update learning path translations with improved translations
-- Note: The learning_path_translations table already exists (created in earlier migration)
-- This migration updates the translations with simpler, more readable versions

-- ============================================================================
-- 1. DROP DUPLICATE TABLE IF EXISTS (cleanup)
-- ============================================================================

DROP TABLE IF EXISTS learning_paths_translations CASCADE;

-- ============================================================================
-- 2. UPDATE HINDI TRANSLATIONS WITH SIMPLER VERSIONS
-- ============================================================================
...
('aaa00000-0000-0000-0000-000000000007', 'hi',
 'दुनिया के लिए दिल',
 'मिशन पर एक वैश्विक दृष्टिकोण विकसित करें और मसीह के लिए अपने समुदाय और राष्ट्रों को प्रभावित करना सीखें। एक गुणा करने वाले शिष्य बनें।'),
...
-- ============================================================================
-- 3. UPDATE MALAYALAM TRANSLATIONS WITH SIMPLER VERSIONS
-- ============================================================================
...
('aaa00000-0000-0000-0000-000000000007', 'ml',
 ...
 'മിഷനുകളെക്കുറിച്ച് ആഗോള വീക്ഷണം വികസിപ്പിക്കുകയും ക്രിസ്തുവിനായി നിങ്ങളുടെ സമൂഹത്തെയും രാഷ്ട്രങ്ങളെയും സ്വാധീനിക്കാൻ പഠിക്കുകയും ചെയ്യുക. ഗുണിക്കുന്ന ശിഷ്യനാകുക.'),
...
-- ============================================================================
-- 4. ADD ENGLISH TRANSLATIONS TO THE TABLE (for consistency)
-- ============================================================================
