...
export const LOCALIZED_VARIANTS_TO_ENGLISH: Record<string, string> = {
  ...
  'रोमियो': 'Romans',
  'भजन-संहिता': 'Psalms',
  // Hinglish (Roman-script transliterations of Hindi Bible book names)
  // Stored as lowercase; normalizeBookName does book.toLowerCase() before lookup.
  // Old Testament
  'utpatti': 'Genesis',
  'utpati': 'Genesis',
  'nirgaman': 'Exodus',
  'nirgman': 'Exodus',
  'laivyavyavastha': 'Leviticus',
  'laivya vyavastha': 'Leviticus',
  'ginati': 'Numbers',
  'ginti': 'Numbers',
  'vyavastha vivaran': 'Deuteronomy',
  'vyavasthavivaran': 'Deuteronomy',
  'vyavstha vivaran': 'Deuteronomy',
  'yahoshu': 'Joshua',
  'yahoshua': 'Joshua',
  'yehoshua': 'Joshua',
  'nyayiyon': 'Judges',
  ...
  '1 rajaon': '1 Kings',
  '2 rajaon': '2 Kings',
  '1 itihas': '1 Chronicles',
  '2 itihas': '2 Chronicles',
  '1 itihaas': '1 Chronicles',
  '2 itihaas': '2 Chronicles',
  'nehemyah': 'Nehemiah',
  'nehemiya': 'Nehemiah',
  'ayyub': 'Job',
  'ayub': 'Job',
  'bhajan sanhita': 'Psalms',
  'bhajan samhita': 'Psalms',
  'bhajan sahita': 'Psalms',
  'bhajansamhita': 'Psalms',
  'zabur': 'Psalms',
  'nitivachan': 'Proverbs',
  'neetivachan': 'Proverbs',
  'neeti vachan': 'Proverbs',
  'niti vachan': 'Proverbs',
  'sabhopadeshak': 'Ecclesiastes',
  'sbhopadeshak': 'Ecclesiastes',
  'sabho padeshak': 'Ecclesiastes',
  'sreshtha geet': 'Song of Solomon',
  'sreshthageet': 'Song of Solomon',
  'shreshtgeet': 'Song of Solomon',
  'yashayah': 'Isaiah',
  'yeshayah': 'Isaiah',
  'yashaya': 'Isaiah',
  'yirmiyah': 'Jeremiah',
  'yirmiyan': 'Jeremiah',
  'vilap geet': 'Lamentations',
  'vilapgeet': 'Lamentations',
  'vilap git': 'Lamentations',
  'yahezkel': 'Ezekiel',
  'yehezkel': 'Ezekiel',
  'daniyal': 'Daniel',
  'hoshe': 'Hosea',
  ...
  'yohanna': 'John',
  'yuohanna': 'John',
  'prairiton ke kam': 'Acts',
  'prairiton ke kaam': 'Acts',
  'preriton ke kaam': 'Acts',
  'preriton ke kam': 'Acts',
  'prariton ke kaam': 'Acts',
  'prariton ke kam': 'Acts',
  'romiyon': 'Romans',
  '1 kurintiyon': '1 Corinthians',
  '2 kurintiyon': '2 Corinthians',
  '1 kurintiyaon': '1 Corinthians',
  '2 kurintiyaon': '2 Corinthians',
  'galatiyon': 'Galatians',
  'galatiyaon': 'Galatians',
  'iphisiyaon': 'Ephesians',
  'ephisiyaon': 'Ephesians',
  'filippiyaon': 'Philippians',
  'filippiyon': 'Philippians',
  'kulussiyaon': 'Colossians',
  'kolussiyon': 'Colossians',
  '1 thissalunikiyon': '1 Thessalonians',
  '2 thissalunikiyon': '2 Thessalonians',
  '1 timotiyus': '1 Timothy',
  '2 timotiyus': '2 Timothy',
  '1 timothiyus': '1 Timothy',
  '2 timothiyus': '2 Timothy',
  'filemon': 'Philemon',
  'ibraniyon': 'Hebrews',
  'ibraniyaon': 'Hebrews',
  'yakub': 'James',
  ...
  'prakashitwakya': 'Revelation',
  'prakashit vakya': 'Revelation',
  // Additional Hindi (Hinglish) variants from frontend pill suggestions
  'levyvyavastha': 'Leviticus',
  'levyi': 'Leviticus',
  'vyavastha': 'Deuteronomy',
  'yehoshu': 'Joshua',
  'nyayi': 'Judges',
  'root': 'Ruth',
  'rut': 'Ruth',
  ...
  'ester': 'Esther',
  'bhajan': 'Psalms',
  'sabhopdesak': 'Ecclesiastes',
  'sabho': 'Ecclesiastes',
  'shreshtha': 'Song of Solomon',
  'yirmayah': 'Jeremiah',
  'yirmya': 'Jeremiah',
  'vilap': 'Lamentations',
  'yahejkel': 'Ezekiel',
  ...
  'preriton': 'Acts',
  'romio': 'Romans',
  '1 korinthi': '1 Corinthians',
  '2 korinthi': '2 Corinthians',
  '1 kuri': '1 Corinthians',
  '2 kuri': '2 Corinthians',
  'galati': 'Galatians',
  'ifisiyon': 'Ephesians',
  'ifisi': 'Ephesians',
  'kulussyon': 'Colossians',
  '1 thissaluni': '1 Thessalonians',
  '2 thissaluni': '2 Thessalonians',
  '1 thissa': '1 Thessalonians',
  '2 thissa': '2 Thessalonians',
  '1 timothy': '1 Timothy',
  '2 timothy': '2 Timothy',
  '1 tiimuthi': '1 Timothy',
  '2 tiimuthi': '2 Timothy',
  'teetus': 'Titus',
  'ibrani': 'Hebrews',
  'yakoob': 'James',
  '1 petrus': '1 Peter',
  ...
  // Malayalam (Manglish) romanized variants from frontend pill suggestions
  // Old Testament
  'ulpa': 'Genesis',
  'uthpathi': 'Genesis',
  'pura': 'Exodus',
  ...
  'iyyob': 'Job',
  'sanki': 'Psalms',
  'sankeerthanam': 'Psalms',
  'sadru': 'Proverbs',
  'sadrushavakhyam': 'Proverbs',
  'sabha': 'Ecclesiastes',
  'sabhaprasangi': 'Ecclesiastes',
  'uttha': 'Song of Solomon',
  'uttamageetham': 'Song of Solomon',
  'yesha': 'Isaiah',
  'yeshayya': 'Isaiah',
  'yire': 'Jeremiah',
  'yiremyav': 'Jeremiah',
  'vila': 'Lamentations',
  'vilapangal': 'Lamentations',
  'yehe': 'Ezekiel',
  'dani': 'Daniel',
  'hoshea': 'Hosea',
  'yove': 'Joel',
  ...
  'roma': 'Romans',
  'romakkar': 'Romans',
  '1 kori': '1 Corinthians',
  '2 kori': '2 Corinthians',
  'gala': 'Galatians',
  'galathyar': 'Galatians',
  'ephe': 'Ephesians',
  'ephesyar': 'Ephesians',
  ...
  'fili': 'Philippians',
  'kolo': 'Colossians',
  '1 thessa': '1 Thessalonians',
  '2 thessa': '2 Thessalonians',
  '1 thimo': '1 Timothy',
  '2 thimo': '2 Timothy',
  '1 timotheyos': '1 Timothy',
  '2 timotheyos': '2 Timothy',
  'teetho': 'Titus',
  'phile': 'Philemon',
  'file': 'Philemon',
  'ebra': 'Hebrews',
