...
const MILESTONE_MESSAGES: MilestoneMessages = {
  7: {
    ...
    hi: {
      title: '🔥 सप्ताह योद्धा!',
      body: 'बढ़िया! आपने 7 दिन पूरे किए! आग जलाए रखें!'
    },
    ml: {
      title: '🔥 വീക്ക് വാരിയർ!',
      body: 'അതിശയകരം! നിങ്ങൾ 7 ദിവസം പൂർത്തിയാക്കി! തീ കത്തിക്കൂ!'
    }
  },
  30: {
    en: {
  ...
  100: {
    ...
    hi: {
      title: '🏆 शताब्दी विद्वान!',
      body: 'उत्कृष्ट! 100 दिनों की निरंतरता! आप अजेय हैं!'
    },
    ml: {
      title: '🏆 സെഞ്ചുറി സ്കോളർ!',
      body: 'മികച്ചത്! 100 ദിവസത്തെ സ്ഥിരത! നിങ്ങൾ തടയാനാവാത്തവരാണ്!'
    }
  },
  365: {
    en: {
    ...
    hi: {
      title: '🌟 वार्षिक चैंपियन!',
      body: 'किंवदंती! दैनिक भक्ति का एक पूरा वर्ष! आप एक प्रेरणा हैं!'
    },
    ml: {
      title: '🌟 വാർഷിക ചാമ്പ്യൻ!',
      body: 'ഐതിഹാസിക! ദൈനംദിന ഭക്തിയുടെ ഒരു പൂർണ്ണ വർഷം! നിങ്ങൾ ഒരു പ്രചോദനമാണ്!'
    }
  }
};
