...
## Tags/Keywords
```
bible study, bible app, christian app, devotional, scripture, bible commentary,
daily verse, bible reading, spiritual growth, faith app, discipleship,
bible study guide, christian devotional, prayer app, bible learning
```
...
1. **Home Screen** - Shows daily verse and welcome message
2. **Study Guide** - AI-generated Bible study content
3. **Follow-up Chat** - AI conversation feature
4. **Study Topics** - Browse topics screen
5. **My Studies** - Saved studies list
6. **Settings** - Multi-language support shown
...
- Content: App logo + tagline "AI-Powered Bible Study"
- Style: Clean, spiritual, professional

---

## App Icon
- Source: `/frontend/web/icons/icon-512.png`
